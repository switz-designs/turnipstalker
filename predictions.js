...
class Predictor {
  ...
  * generate_possibilities(sell_prices, first_buy, previous_pattern) {
  ...
  analyze_possibilities() {
    ...
    // console.log(`Sell prices: ${sell_prices}, ${sell_prices.length} items`)
    const first_buy = this.first_buy;
    // console.log(`First buy: ${first_buy}`)
    const previous_pattern = this.previous_pattern;
    // console.log(`Previous pattern: ${previous_pattern}`)
    ...
    for (let i = 0; i < 6; i++) {
      ...
      // console.log(`generated_possibilities: ${generated_possibilities}`)
